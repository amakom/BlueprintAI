...
export async function POST(req: Request) {
  try {
    ...
    try {
      const systemPrompt = "You are an expert User Researcher. Generate 3 detailed User Personas for the product described by the user. Return a JSON object with a single key 'personas' containing an array of objects. Each object must have 'name', 'role', 'bio', 'goals' (array of strings), and 'frustrations' (array of strings).";
