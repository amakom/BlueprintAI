      ...
      <main className="relative z-10">
        ...
        <section className="container mx-auto px-6 py-20 border-t border-white/5">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <FadeUp delay={0.2} className="bg-white/5 rounded-3xl p-8 md:p-12 border border-white/10 text-left">
        ...
        <section className="container mx-auto px-6 py-20 text-center border-t border-white/5">
          <FadeUp>
            ...
            <div className="flex flex-wrap justify-center gap-8 md:gap-16 opacity-50 grayscale">
              ...
              <span className="text-xl font-bold">Stark Industries</span>
              <span className="text-xl font-bold">Wayne Enterprises</span>
        ...
        <section className="container mx-auto px-6 py-32 text-center">
          <FadeUp>
            <h2 className="text-4xl md:text-6xl font-bold mb-6">Ready to build better products?</h2>
            <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto">Join the waitlist and be the first to experience the future of product planning.</p>
