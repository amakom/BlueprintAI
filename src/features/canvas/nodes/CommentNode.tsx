...
export const CommentNode = memo(({ data }: NodeProps) => {
  return (
    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 shadow-sm w-52 text-xs font-sans hover:shadow-md transition-shadow cursor-default">
      <div className="flex items-center gap-2 mb-2 border-b border-yellow-100 pb-1">
        <div className="w-4 h-4 rounded-full bg-yellow-500 text-white flex items-center justify-center font-bold text-[9px]">
