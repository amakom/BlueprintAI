...
export function ScreenNode({ id, data, selected }: NodeProps<Node<ScreenNodeData>>) {
  ...
  return (
    ...
    >
      ...
      {/* Phone Header */}
      <div className="h-6 bg-navy rounded-t-lg flex items-center justify-between px-2 relative shrink-0 transition-colors z-10">
      ...
      {/* Screen Content */}
      <div className="flex-1 relative overflow-hidden group flex flex-col transition-colors rounded-b-lg">
        {hasImage ? (
             <img 
            ...
            <>
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-gray-300 group-hover:text-gray-400 transition-colors w-full text-center px-4 z-10">
                ...
                <div className="space-y-2 opacity-30 pointer-events-none w-full flex-1 p-3">
